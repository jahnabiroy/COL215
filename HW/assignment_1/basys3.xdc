...
set_property PACKAGE_PIN W6 [get_ports {a2}]                                       
...
set_property PACKAGE_PIN U4 [get_ports {b1}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {b1}]
set_property PACKAGE_PIN V4 [get_ports {b2}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {b2}]
set_property PACKAGE_PIN W4 [get_ports {b3}]                                        
