...
set_property PACKAGE_PIN W5 [get_ports clk]                                                    
        ...
        #create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clok]
...
##7 segment display
#set_property PACKAGE_PIN W7 [get_ports {o1}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o1}]
#set_property PACKAGE_PIN W6 [get_ports {o2}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o2}]
#set_property PACKAGE_PIN U8 [get_ports {o3}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o3}]
#set_property PACKAGE_PIN V8 [get_ports {o4}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o4}]
#set_property PACKAGE_PIN U5 [get_ports {o5}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o5}]
#set_property PACKAGE_PIN V5 [get_ports {o6}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o6}]
#set_property PACKAGE_PIN U7 [get_ports {o7}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {o7}]

#set_property PACKAGE_PIN V7 [get_ports dp]                                                     
        #set_property IOSTANDARD LVCMOS33 [get_ports dp]

#set_property PACKAGE_PIN U2 [get_ports {m1}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {m1}]
#set_property PACKAGE_PIN U4 [get_ports {m2}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {m2}]
#set_property PACKAGE_PIN V4 [get_ports {m3}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {m3}]
#set_property PACKAGE_PIN W4 [get_ports {m4}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {m4}]
